  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        // $FlowFixMe
        .map(function (entity) {
          return _react2.default.createElement(_component7.default, { key: entity.id, links: entity.linksTo, from: entity.id });
        }),
...
var CanvasContainer = function (_React$PureComponent) {
  ...
  function CanvasContainer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args))), _this), _this.zoomSteps = [0.25, 0.5, 0.75, 1, 1.5, 2, 4], _this.state = {
      ...
      return _ref = {}, _ref[type] = (0, _component3.default)((0, _reactRedux.connect)(null, { setName: _reducer3.setName, setModel: _reducer3.setModel })(_this.props.customEntities[type].component)), _ref;
